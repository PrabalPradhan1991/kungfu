				...
				<div class="card-body">
					<div class="col-sm-10">
						<div class="form-group">
							...
							<input id="stage_name" type="text" name="stage[stage_name]" class="form-control stage_name" required value="{{ request()->old('stage_name') }}">
						...
						<div class="form-group">
							...
							<textarea name="stage[stage_description]" class="form-control" rows="5">{{ request()->old('stage_description') }}</textarea>
						...
						<div class="form-group">
							...
							<input id="ordering" type="number" name="stage[ordering]" step=1 min=0 class="form-control ordering" value="{{ \App\Http\Controllers\HelperController::getOrdering('\App\Http\Controllers\CoreModules\Videos\StageModel', 'ordering') }}" required>
